 ...
 */
export const postV0ExtmsgClients = <ThrowOnError extends boolean = false>(options: Options<PostV0ExtmsgClientsData, ThrowOnError>) => (options.client ?? client).post<PostV0ExtmsgClientsResponses, PostV0ExtmsgClientsErrors, ThrowOnError>({
 ...
 *
 * Server-Sent Events stream of outbound messages for the given connected-client conversation. Authenticate with X-GC-Client-Token. Reconnect with Last-Event-ID to replay missed replies.
 */
export const streamConnectedClientConversation = <ThrowOnError extends boolean = false>(options: Options<StreamConnectedClientConversationData, ThrowOnError, StreamConnectedClientConversationResponse>) => (options.client ?? client).sse.get<StreamConnectedClientConversationResponses, StreamConnectedClientConversationErrors, ThrowOnError>({ url: '/v0/extmsg/clients/{account_id}/conversations/{conversation_id}/subscribe', ...options });

/**
 * Post v0 extmsg inbound
 */
export const postV0ExtmsgInbound = <ThrowOnError extends boolean = false>(options: Options<PostV0ExtmsgInboundData, ThrowOnError>) => (options.client ?? client).post<PostV0ExtmsgInboundResponses, PostV0ExtmsgInboundErrors, ThrowOnError>({
