...
export interface components {
    schemas: {
        ...
        StoreBackstopLeakDetectedPayload: {
            /**
             * Format: int64
             * @description Closed ephemeral beads reclaimed by the backstop sweep.
             */
            ephemeral_count: number;
            /**
             * Format: int64
             * @description Closed main-tier beads reclaimed by the backstop sweep.
             */
            main_count: number;
            /**
             * Format: int64
             * @description Configured leak threshold that the total reclaim count exceeded.
             */
            threshold: number;
            /**
             * Format: int64
             * @description Total closed beads reclaimed by the backstop sweep.
             */
            total_count: number;
        };
        ...
        TypedEventStreamEnvelopeGcStoreBackstopLeakDetected: {
            actor: string;
            message?: string;
            payload: components["schemas"]["StoreBackstopLeakDetectedPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
